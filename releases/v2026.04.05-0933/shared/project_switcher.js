...
;(function (root) {
  ...
  function resolveNewProjectHref() {
    return String(root.location && root.location.pathname || '').indexOf('/pages/') !== -1
      ? 'new_project.html'
  ...
  function render(container, options) {
    ...
    createLink.className = `${CSS_CLASS}__create`;
    createLink.href = resolveNewProjectHref();
    createLink.textContent = '新建项目';
