(function (global) {
  ...
  function build(runtimeInput, stageKey, options) {
    ...
    const templateBase = global.G281CustomerQuoteTemplateAdapter
      ? global.G281CustomerQuoteTemplateAdapter.build(runtime, 'geely', baselineKey, safeOptions)
      : { fields: [] };
    const templateCompare = global.G281CustomerQuoteTemplateAdapter
      ? global.G281CustomerQuoteTemplateAdapter.build(runtime, 'geely', comparisonKey, safeOptions)
      : { fields: [] };
