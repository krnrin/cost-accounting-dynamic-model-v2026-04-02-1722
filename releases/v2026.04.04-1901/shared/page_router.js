...
(function (global) {
  ...
  const STORAGE_KEY = 'lifecycle_cost_platform.page_state.v1';
  const LEGACY_STORAGE_KEY = 'g281_page_state';
  const CHANNEL_NAME = 'lifecycle_cost_platform.page_sync.v1';
