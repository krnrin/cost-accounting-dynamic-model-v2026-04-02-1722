...
function ensureDashboardUiScaffold() {
  ...
  if (main) {
    ...
    if (heroSection) {
      ...
      ['openBomValidationBtn', 'openCapitalValidationBtn', 'openLaborValidationBtn', 'openPackagingValidationBtn', 'openAnnualDropManagerBtn', 'openOneTimeCustomerManagerBtn', 'openRebateManagerBtn', 'openFactoryEfficiencyBtn'].forEach((id) => {
        const node = document.getElementById(id);
