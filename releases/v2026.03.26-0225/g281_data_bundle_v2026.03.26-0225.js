...
,
  ...
  "meta": {
    ...
    "portfolioRule": "all_confirmed_protocol_else_sample",
    "portfolioRuleNote": "Initialization rule: when all mapped rows under one aggregated connector are confirmed, switch to protocol pricing; otherwise switch to sample pricing, and keep manual per-item override available."
  },
  "summary": {
    "totalRows": 20,
    "confirmed": 8,
