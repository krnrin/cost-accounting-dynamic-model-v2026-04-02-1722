(function (global) {
  ...
  function setWindowMinimized(minimized) {
    if (!modal) return;
    modal.classList.toggle('is-window-minimized', Boolean(minimized));
    if (!minimized) {
  ...
  function setWindowMaximized(maximized) {
    if (!modal) return;
    modal.classList.toggle('is-window-maximized', Boolean(maximized));
    refs.panel?.classList.toggle('is-window-maximized', Boolean(maximized));
