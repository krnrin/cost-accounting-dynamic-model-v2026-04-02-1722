(function (global) {
  ...
  const DEFAULT_NODES = [
    { key: 'harness', label: 'Harness', artifactType: 'harness', scope: 'harness', sequence: 10 },
    { key: 'bom', label: 'BOM', artifactType: 'bom', scope: 'harness', sequence: 20 },
    { key: 'quotation', label: 'Quotation', artifactType: 'quotation', scope: 'harness', sequence: 30 },
    { key: 'labor', label: 'Labor', artifactType: 'labor', scope: 'harness', sequence: 40 },
    { key: 'packaging', label: 'Packaging', artifactType: 'packaging', scope: 'harness', sequence: 50 },
    { key: 'capital', label: 'Capital', artifactType: 'capital', scope: 'harness', sequence: 60 },
    { key: 'approval', label: 'Approval', artifactType: 'approval', scope: 'project', sequence: 70 },
  ];
