(function (global) {
  ...
  const STATE_GROUPS = ['bom', 'metal', 'connector', 'labor', 'equipment', 'packaging', 'sales', 'mix', 'annualDrop', 'oneTimeCustomer', 'rebate', 'vave'];
  ...
  const BASELINE_KEY_HINTS = {
    ...
    sales: ['quote', 'base'],
    mix: ['quote', 'base'],
    annualDrop: ['quote', 'base'],
    oneTimeCustomer: ['quote', 'base'],
    rebate: ['quote', 'base'],
