    ...
    <Layout className="page-container">
      ...
      {showRateConfig && project && (
        <RoleGuard field="costRates" readOnlyFallback>
          <Card title="项目费率配置" style={{ marginBottom: 16, background: 'var(--semi-color-bg-2)' }}>
            <Row gutter={[12, 12]}>
              <Col span={4}>
      ...
      {computedResults.length === 0 ? (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 400, background: 'var(--semi-color-bg-1)', borderRadius: 8, marginTop: 24 }}>
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 24, marginBottom: 24 }}>
            ...
            <Card title="线束成本清单" style={{ background: 'var(--semi-color-bg-2)' }}>
          ...
          <Card title="项目生命周期成本趋势" style={{ background: 'var(--semi-color-bg-2)', marginBottom: 24 }}>
      ...
      <Card title="数据校验" style={{ background: 'var(--semi-color-bg-2)', marginBottom: 24 }}>
