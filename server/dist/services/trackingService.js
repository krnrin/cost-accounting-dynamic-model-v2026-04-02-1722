...
function mapDiscrepancyStatus(status) {
    switch (status) {
        case 'escalated':
            return 'in_progress';
        case 'resolved':
...
function mapDiscrepancySeverity(rate) {
...
function mapDiscrepancyTrackingType(partCategory) {
...
export class TrackingService {
    ...
    static async upsertFromPriceDiscrepancy(discrepancy) {
